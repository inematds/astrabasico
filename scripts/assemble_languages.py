...
ROOT=Path('/home/nmaldaner/projetos/output/astrabasico')
def ts(s):
...
def assemble(lang):
 ...
 dest=ROOT/'final'/f'astra-basico-{lang}.mp4';receipt=ROOT/'verification'/f'assembled-{lang}.json'
 ...
 (ROOT/'final'/f'astra-basico-{lang}.srt').write_text('\n'.join(subs))
